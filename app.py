...
for k,v in [('dati',[]),('post',[]),('icone',[]),('tipologie',[]),('menu','Dashboard'),('auth',False),('lat_tmp',45.8205),('lon_tmp',8.8250),('com_tmp',''),('via_tmp',''),('map_expand',False),('map_all_expand',False),('sel_idx',-1),('zoom_level',16)]:
...
if st.session_state.map_expand or st.session_state.map_all_expand:
 ...
 if st.session_state.map_all_expand:
  st.markdown('## MAPPA TUTTE POSTAZIONI - SCHERMO INTERO')
 ...
 if scelta=='Dashboard':
  ...
  torna()
  st.markdown('#### MAPPA - ESPANSIONE A SCHERMO INTERO')
