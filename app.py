...
def header():
 # INTESTAZIONE CON LOGO - NO BASE64
 try:
  c1,c2,c3=st.columns([1,2,1])
  with c2:
   st.image("logo.png",width=80)
   st.markdown(
    "<h3 style='text-align:center;color:#0e7a3d;margin:2px;'>VOLONTARIATO Varese</h3>",
    unsafe_allow_html=True
   )
 except:
  st.markdown(
...
# MENU CON LOGO E COLORE VERDE
with st.sidebar:
 try:
  st.image("logo.png",width=80)
 except:
  st.markdown("**VOLONTARIATO**")
 opts=[
  "Dashboard",
  "Volontari",
  "Mappa",
...
if scelta=="Dashboard":
 st.markdown("#### DASHBOARD CON LOGO")
 ...
 st.markdown("##### 1 - ANTEPRIMA PER INSERIRE POSTAZIONI")
 st.info("Mappa per inserire - come stamattina")
