...
if st.session_state.page == 'entra':
    ...
    if m == 'Dashboard':
        st.markdown('## Dashboard - MENU RAPIDO FUNZIONANTE')
        st.info('Clicca sui tasti sotto e apre il form - come avevi chiesto')
        ...
        st.divider()
        st.markdown('### MENU RAPIDO - CLICCA E APRE IL FORM')
        # RIGA 1
        r1 = st.columns(4)
        with r1[0]:
        ...
        with r4[0]:
            if st.button('CREA NUOVO FORM', use_container_width=True, type='primary'):
                ...
                st.rerun()
        with r4[1]:
            st.markdown(f"**Form personalizzati: {len(menu_custom)}**")
        ...
        st.markdown('## VOLONTARI - MASCHERA')
